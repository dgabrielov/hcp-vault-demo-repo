...
# Needs admin role.
HCP_CLIENT_ID=<INSERT HCP CLIENT ID>
HCP_CLIENT_SECRET=<INSERT HCP CLIENT SECRET>
...
HCP_ORGANIZATION_ID="<INSERT HCP ORG ID>"
HCP_PROJECT_ID="eff70472-d252-4d87-b64f-2a829c2ae5df"
...
# but you may have changed it.
HCP_CLUSTER_ID=hcpv-plus-controlGroupDemo
